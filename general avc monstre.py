...
while running:
    ...
    if not en_pause and not transition_recommencer and not transition_porte_enfer_start and etat != "mort":
        ...
        monstre.update(joueur.rect, plateformes + plateformes_prison + sol)
        vies, invincible, invincibilite_temps, mort = monstre.verifier_collision_joueur(joueur.rect, vies, invincible, current_time, invincibilite_temps, duree_invincibilite)
        if mort:
            sfx.degat.play()
