...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # Inventaire — ouvrir avec F
            elif event.key == pygame.K_f and not inventaire_affiche and not lire_pancarte and not dialogue_g and not dialogue_v:
                inventaire_affiche = True
                joueur.peut_bouger = False
                inventaire_timer = current_time
                show_button_f_inventaire = False

            # Inventaire — fermer avec F
        ...
        # Clics souris — équipement bottes uniquement
        if event.type == pygame.MOUSEBUTTONDOWN:

            # Clic sur le carré des bottes → toggle tooltip
            ...
            # Clic sur le bouton "Équiper" / "Déséquiper" du tooltip
    ...
    # ---- Timers ----
    if inventaire_affiche and not show_button_f_inventaire and current_time - inventaire_timer > 3000:
