...
def plateforme_pic2():
    return [
            ...
            pygame.Rect(3170, 4600,150,80),
            pygame.Rect(3850, 4500, 150, 80),
            pygame.Rect(4000, 4500, 150, 80),
...
def plateforme_2():
    return [
        pygame.Rect(2500, 6380, 110,40),
        pygame.Rect(3100, 6000, 400,160),
        pygame.Rect(2780, 6180, 110,40),
        pygame.Rect(3100, 5497, 400,160),
        pygame.Rect(2800, 5720, 110,40),
        pygame.Rect(2540, 5250, 110,40),
        pygame.Rect(2740, 5050, 110,40),
        pygame.Rect(3140, 4050, 110,40),
        pygame.Rect(3040, 4050, 110,40),
        pygame.Rect(3170, 4680, 150, 40),
    ]
