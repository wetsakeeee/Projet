...
#Polices d'écritures
try :   
    Police_titre = pygame.font.Font("asset/Coolvetica Rg.otf", 72)
    Police_bouton =  pygame.font.Font("asset/Coolvetica Rg.otf", 36)
...
#Musique et son
musique_menu = pygame.mixer.Sound("asset/menu.ogg")
musique_menu.play(-1,0,3000) #boucle infini
musique_menu.set_volume(1.0)
son_bouton = pygame.mixer.Sound("asset/bouton.mp3")
