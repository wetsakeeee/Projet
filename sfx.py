...
couteausfx = pygame.mixer.Sound("asset/sons/Sfx/Joueur/couteau.wav")
...
niveau_2caronte = pygame.mixer.Sound("asset/sons/Musique/niveau_2.mp3")
...
choisirsfx = pygame.mixer.Sound("asset/sons/Sfx/Boutons/choisir.wav")
retoursfx = pygame.mixer.Sound("asset/sons/Sfx/Boutons/retour.wav")
...
# SFX des monstres
fireballsfx = pygame.mixer.Sound("asset/sons/Sfx/Monstres/fireball.wav")
degat1 = pygame.mixer.Sound("asset/sons/Sfx/Monstres/degat1.wav")
degat2 = pygame.mixer.Sound("asset/sons/Sfx/Monstres/degat2.wav")

squelette1 = pygame.mixer.Sound("asset/sons/Sfx/Monstres/squelette1.mp3")
squelette2 = pygame.mixer.Sound("asset/sons/Sfx/Monstres/squelette2.mp3")
squelette3 = pygame.mixer.Sound("asset/sons/Sfx/Monstres/squelette3.mp3")

# Porte
debloquer_porte = pygame.mixer.Sound("asset/sons/Sfx/Porte/porte_debloque.mp3")
porte_entrer    = pygame.mixer.Sound("asset/sons/Sfx/Porte/porte_entrer.wav")
porte_sortir    = pygame.mixer.Sound("asset/sons/Sfx/Porte/porte_sortir.wav")

indicesfx = pygame.mixer.Sound("asset/sons/Sfx/Boutons/indice.wav")
paradis   = pygame.mixer.Sound("asset/sons/Musique/paradis.mp3")
